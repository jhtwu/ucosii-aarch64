...
#define NOTHING() 0
#define NOTHING1(val) 0
#define  CPU_INT_DIS() NOTHING()
#define  CPU_INT_EN() NOTHING()
...
#define  CPU_MB()       NOTHING()
#define  CPU_RMB()      NOTHING()
#define  CPU_WMB()      NOTHING()
...
#define  CPU_CLZ(val) __builtin_clz(val)
