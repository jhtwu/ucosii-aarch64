 ...
 */
/* Current EL with SP0 */
#define AARCH64_EXC_SYNC_SP0      (0x000)   /* Synchronous */
#define AARCH64_EXC_IRQ_SP0       (0x080)   /* IRQ/vIRQ */
#define AARCH64_EXC_FIQ_SP0       (0x100)   /* FIQ/vFIQ */
#define AARCH64_EXC_SERR_SP0      (0x180)   /* SError/vSError */
/* Current EL with SPx */
#define AARCH64_EXC_SYNC_SPX      (0x200)
#define AARCH64_EXC_IRQ_SPX       (0x280)
#define AARCH64_EXC_FIQ_SPX       (0x300)
#define AARCH64_EXC_SERR_SPX      (0x380)
/* Lower EL using AArch64 */
#define AARCH64_EXC_SYNC_AARCH64  (0x400)
#define AARCH64_EXC_IRQ_AARCH64   (0x480)
#define AARCH64_EXC_FIQ_AARCH64   (0x500)
#define AARCH64_EXC_SERR_AARCH64  (0x580)
/* Lower EL using AArch32 */
#define AARCH64_EXC_SYNC_AARCH32  (0x600)
#define AARCH64_EXC_IRQ_AARCH32   (0x680)
#define AARCH64_EXC_FIQ_AARCH32   (0x700)
#define AARCH64_EXC_SERR_AARCH32  (0x780)
