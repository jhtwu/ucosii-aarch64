...
#define  APU_FREQ         (792000000U)                          /* Core frequency.                                      */
#define  PERIPH_FREQ      (APU_FREQ/2)                          /* Private peripherals freq.                            */

//Ruby Modified
//#define  ARM_PRIV_PERIPH_BASE  (0x00A00000)                     /* CPU private peripheral base address.                 */
#define  ARM_PRIV_PERIPH_BASE  (0x1e000000)                     /* CPU private peripheral base address.                 */
