...
OS_EXT  unsigned long long          OSPrioCur;                /* Priority of current task                        */
OS_EXT  unsigned long long          OSPrioHighRdy;            /* Priority of highest priority task               */
OS_EXT  unsigned long long          OSRunning;                       /* Flag indicating that kernel is running   */
OS_EXT  unsigned long long          OSIntNesting;             /* Interrupt nesting level                         */
